# Hanko Documentation - LLM Reference
...
- **Web Components**: Pre-built UI elements (login forms, registration, profile management) that can be embedded in any web application
- **Authentication APIs**: Backend services handling user registration, login validation, session management
- **User Management**: Full user lifecycle including registration, profile updates, account deletion
- **Session Handling**: Secure JWT (JSON Web Token) based sessions with configurable expiration
...
**Reference**: https://docs.hanko.io/guides/authentication-methods/saml/introduction

Enterprise identity provider integrations:
- **Auth0**: https://docs.hanko.io/guides/authentication-methods/saml/auth0
- **Microsoft Entra** (formerly Azure AD): https://docs.hanko.io/guides/authentication-methods/saml/entra  
- **Google Workspace**: https://docs.hanko.io/guides/authentication-methods/saml/google
- **Okta**: https://docs.hanko.io/guides/authentication-methods/saml/okta
...
- **Languages**: 30+ languages supported including RTL languages
...
- **Global CDN**: Low-latency access worldwide via CloudFlare
- **High Availability**: 99.9% uptime SLA with multi-region deployment
- **Built-in Monitoring**: Real-time dashboards and alerting
...
### User Migration
**Reference**: https://docs.hanko.io/guides/migrations/import-export-users
...
1. **Configure Identity Provider**
   - Okta: https://docs.hanko.io/guides/authentication-methods/saml/okta
   - Microsoft Entra: https://docs.hanko.io/guides/authentication-methods/saml/entra  
   - Auth0: https://docs.hanko.io/guides/authentication-methods/saml/auth0
   - Google Workspace: https://docs.hanko.io/guides/authentication-methods/saml/google
