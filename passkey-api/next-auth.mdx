...
Once you’ve initialized your Next app with [NextAuth](https://authjs.dev/reference/nextjs), install our passkey provider.
...
export default function LoginForm() {
  ...
  useEffect(() => {
    return signInWithPasskey.conditional({ tenantId: process.env.NEXT_PUBLIC_PASSKEYS_TENANT_ID });
  }, []);
