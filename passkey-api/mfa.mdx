...
This example demonstrates how to implement MFA in a Next.js 14 application using the [@teamhanko/passkeys-sdk](https://www.npmjs.com/package/@teamhanko/passkeys-sdk). If you're not using a JS/TS backend, you can achieve the same result by utilizing the [Passkey API](/passkey-api/reference/credentials/start-mfa-login) directly.

## Install Passkey SDK

First, install the Passkey SDK:
