...
#constants 
API_URL = "https://b50e27f9-962a-40bb-89e0-26431366b224.hanko.io" #change this to your url fro cloud.hanko.io
AUDIENCE = "localhost" # change this to the url you're hosting on, and make sure it matches the URL on cloud.hanko.io
...
<body>
    ...
    <script type="module">
        ...
        const { hanko } = await register("{{ API_URL }}"); //this is be changed to the API_URL provided in example.py
