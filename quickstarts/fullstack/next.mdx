...
<div class="hidden">
This guide shows how to integrate Hanko into a Next.js application. You'll import and setup the authentication components, implement session management, secure routes with middleware, and handle user data.

Key tasks: Install Hanko Elements, import and setup HankoAuth and HankoProfile components, add logout functionality, implement route protection, and retrieve user data.
...
<div class="hidden">
Creates a new Next.js application with latest version and default settings
</div>
...
<div class="hidden">
Installs the Hanko Elements package which provides pre-built authentication components
</div>
...
<div class="hidden">
Environment variable for Hanko API URL - must be prefixed with NEXT_PUBLIC_ to be accessible in browser
</div>
...
<div class="hidden">
TypeScript declarations for Hanko web components to enable type checking and IntelliSense
</div>
...
<div class="hidden">
App Router version: Authentication component with session event handling and redirect logic after successful login
</div>
...
<div class="hidden">
Pages Router version: Authentication component using next/router instead of next/navigation
</div>
...
<Tab title="App directory">
<div class="hidden">
App Router logout button component with session cleanup and navigation
</div>
...
<div class="hidden">
Next.js middleware for protecting routes by validating Hanko session tokens
</div>
...
<Tab title="App directory">
<div class="hidden">
App Router dashboard with client-side user data retrieval using Hanko SDK
</div>
...
<div class="hidden">
Server-side function to validate session and fetch user data using Hanko API
</div>
