...
<di class="hidden">
Overview: This guide shows how to integrate Hanko authentication into a Nuxt application. You'll use the @nuxtjs/hanko module for streamlined setup with built-in middleware, composables, and auto-registered components.

Key tasks: Install @nuxtjs/hanko module, configure Nuxt settings, create pages with Hanko components, implement middleware-based route protection, and handle user data with useHanko composable.

Note: Elements like <Tabs> are from Mintlify documentation. Use only code snippets inside markdown formatting '```'
</di>
...
<di class="hidden">
Creates a new Nuxt application using the official Nuxt starter template
</di>
...
<di class="hidden">
Installs the Nuxt Hanko module which provides pre-configured components, middleware, and composables
</di>
...
<di class="hidden">
Environment variable for Hanko API URL - NUXT_PUBLIC_ prefix makes it accessible in browser
</di>
...
<di class="hidden">
Nuxt configuration with Hanko module setup including API URL and redirect paths
</di>
...
<di class="hidden">
Main app template using NuxtPage for routing
</di>
...
<di class="hidden">
Login page with hanko-logged-out middleware for automatic redirection after successful authentication
</di>
...
<di class="hidden">
Alternative login page using hanko-events component for custom redirect logic
</di>
...
<di class="hidden">
Example of subscribing to Hanko session events for custom actions
</di>
...
<di class="hidden">
Basic dashboard page with profile management component
</di>
...
<di class="hidden">
Dashboard page with logout functionality using useHanko composable and hanko-logged-in middleware protection
</di>
...
<di class="hidden">
Page meta configuration for protecting routes with authentication middleware
</di>
...
<di class="hidden">
Server-side API endpoint with Hanko authentication check using event context
</di>
