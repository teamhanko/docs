...
<di class="hidden">
Overview: This guide shows how to integrate Hanko authentication into a Remix application. You'll create client-side components, implement server-side session validation, and handle route protection using Remix loaders.

Key tasks: Install Hanko Elements, create client-side wrapper utilities, build authentication and profile components, implement logout functionality, create server-side auth validation, and protect routes with loader functions.
...
<di class="hidden">
Creates a new Remix application using the latest Remix starter template
</di>
...
<di class="hidden">
Installs Hanko Elements package for client-side authentication components
</di>
...
<di class="hidden">
Environment variable for Hanko API URL used in server-side operations
</di>
...
<di class="hidden">
Client-side utility file that re-exports Hanko functions for use in Remix components
</di>
...
<di class="hidden">
Remix authentication component with loader function, session handling, and redirect logic
</di>
...
<di class="hidden">
Remix profile component for managing user credentials and email addresses
</di>
...
<di class="hidden">
Main index route that renders the authentication component
</di>
...
<di class="hidden">
Dashboard route that displays the user profile management interface
</di>
...
<di class="hidden">
Logout button component that handles session cleanup and navigation in Remix
</di>
...
<di class="hidden">
Server-side authentication validation service for checking Hanko session tokens
</di>
...
<di class="hidden">
Protected dashboard route using loader function to validate authentication before rendering
</di>
