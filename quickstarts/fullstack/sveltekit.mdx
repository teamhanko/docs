...
<di class="hidden">
Overview: This guide shows how to integrate Hanko authentication into a SvelteKit application. You'll create Svelte components for authentication, implement server-side session validation with hooks, and handle user data retrieval.

Key tasks: Install Hanko Elements, create HankoAuth and HankoProfile Svelte components, implement logout functionality, secure routes with server hooks, and retrieve user data using the Hanko SDK.
...
<di class="hidden">
Creates a new SvelteKit application using the official SvelteKit create command
</di>
...
<di class="hidden">
Installs Hanko Elements package for authentication components in SvelteKit
</di>
...
<di class="hidden">
Environment variable for Hanko API URL - PUBLIC_ prefix makes it accessible in browser
</di>
...
<di class="hidden">
Svelte authentication component with session event handling and navigation
</di>
...
<di class="hidden">
Main page route that renders the authentication component
</di>
...
<di class="hidden">
Svelte profile component for managing user credentials and email addresses
</di>
...
<di class="hidden">
Dashboard page route that displays the user profile management interface
</di>
...
<di class="hidden">
Svelte logout button component with session cleanup and navigation
</di>
...
<di class="hidden">
SvelteKit server hooks for route protection using session validation middleware
</di>
...
<di class="hidden">
Dashboard page with user data retrieval and display using Hanko SDK
</di>
