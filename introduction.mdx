...
description: "Learn how to integrate Hanko to onboard and authenticate users seamlessly."
icon: "hand-wave"
mode: wide
---
...
<Tip>
Please note that Hanko is a complete authentication solution. If you only want to add passkeys to your existing authentication solution, check out [Passkey API](/passkey-api/introduction).
