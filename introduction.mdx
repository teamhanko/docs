...
description: "Hanko is a modern open source authentication solution and the fastest way you integrate passkeys, 2FA, SSO, and more—with full control over your data. Move between self-hosted and Hanko Cloud anytime. No lock-in. Just Auth how it should be: secure, user friendly, and fully yours."
mode: wide
---
...
<CardGroup cols={2}>
  ...
  >
    ...
    [Discover all guides >>](/quickstarts)
