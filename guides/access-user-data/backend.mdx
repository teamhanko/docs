...
<div class="hidden">
    ...
    **What This Guide Covers**: This comprehensive guide demonstrates how to retrieve user data from Hanko in backend environments, including validating sessions, extracting information from JWTs, and using the Admin API.
...
<Note>
    You can refer to the [User Metadata guide](/guides/access-user-data/user-metadata) for details on managing
