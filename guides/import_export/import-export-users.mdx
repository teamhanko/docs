...
Structure your import file as a JSON array of user objects. Each object represents one user with their details. Reference the official [schema](https://raw.githubusercontent.com/teamhanko/hanko/refs/heads/main/backend/json_schema/hanko.user_import.json) for proper data formatting.
