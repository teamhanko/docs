...
title: Migrate Users from Firebase Authentication
description: Learn how to migrate users exported from Firebase with the Firebase CLI to Hanko.
---

## Overview

Hanko supports migrating users from Firebase Authentication while allowing them to continue signing in with their existing passwords.
