...
title: Set up SAML SSO with Microsoft Entra
description: Learn how to set up enterprise connections in Hanko for customers using Microsoft Entra as SAML identity provider.
---
