---
title: Set up Sign in with LinkedIn using Hanko
sidebarTitle: LinkedIn
description: Step-by-step guide to integrating Sign in with LinkedIn using Hanko. Enable secure authentication and seamless onboarding for your app's users.
---
