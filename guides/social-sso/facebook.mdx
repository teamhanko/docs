---
title: Set up Sign in with Facebook using Hanko
sidebarTitle: Facebook
description: Step-by-step guide to integrating Sign in with Facebook using Hanko. Enable secure authentication and seamless onboarding for your app's users.
---
