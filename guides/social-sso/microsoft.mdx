---
title: Set up Sign in with Microsoft using Hanko
sidebarTitle: Microsoft
description: Step-by-step guide to integrating Sign in with Microsoft using Hanko. Enable secure authentication and seamless onboarding for your app's users.
---
