---
title: Set up Sign in with GitHub using Hanko
sidebarTitle: GitHub
description: Step-by-step guide to integrating Sign in with GitHub using Hanko. Enable secure authentication and seamless onboarding for your app's users.
---
...
- Configure GitHub OAuth credentials in Hanko Console
...
<Step title="Implement Sign in with GitHub in your frontend application">
