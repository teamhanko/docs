...
title: Hanko Elements internationalization (i18n) guide
description: Hanko Elements support multiple languages and translations can be modified to alter headlines, labels, descriptions and all other texts displayed in Hanko Elements.
---
