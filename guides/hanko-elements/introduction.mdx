...
a handler for the "onAuthFlowCompleted" event should be added, to customize the behaviour after the authentication flow has been completed
...
<CardGroup cols={3}>
  <Card title="Auth Component" href="/guides/hanko-elements/auth-component">
    Handles user login and user registration.
  </Card>
  <Card title="Profile Component" href="/guides/hanko-elements/profile-component">
    Allows to manage emails, passwords and passkeys.
  </Card>
  <Card title="Events Component" href="/guides/hanko-elements/events-component">
    Binds event handler to certain events, without displaying UI elements.
  </Card>
</CardGroup>
