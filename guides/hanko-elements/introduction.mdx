...
**What This Guide Covers**: This guide introduces Hanko Elements, a collection of pre-built web components that provide modern authentication functionality. You'll learn about the available components, their features, and how to get started with implementing passwordless authentication in your applications.

**Key Technologies**: Hanko Elements, Web Components, JavaScript/TypeScript, passkeys, OAuth SSO, 2FA authentication, CSS customization, internationalization, and modern web frameworks integration.

**Prerequisites**: Basic knowledge of frontend development, HTML/JavaScript, and web components. Familiarity with your chosen frontend framework and an active Hanko account.
...
<CardGroup cols={2}>
  <Card
    ...
    href="/guides/hanko-elements/auth-component"
  >
    Pre-built components that provide fully-functional authentication and user management in minutes.
  </Card>
  <Card
    title="Customization"
    icon={
  ...
  >
    Fully customize web components to match your design and branding.
  </Card>
  <Card
  ...
  >
    Flexible integration options including CDN or npm installation.
  </Card>
</CardGroup>
