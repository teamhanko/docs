...
<CardGroup cols={3}>
  <Card title="Auth Component" href="/quickstarts/fullstack/next">
    Handles user login and user registration.
  </Card>
  <Card title="Profile Component" href="/quickstarts/frontend/react">
    Allows to manage emails, passwords and passkeys.
  </Card>
  <Card title="Events Component" href="/quickstarts/frontend/react">
