...
[Patch metadata of a user](/api-reference/admin/user-management/patch-metadata-of-a-user) endpoint.
...
- `Admin API`:
    - Unsafe metadata can be set using the
      [Patch metadata of a user](/api-reference/admin/user-management/patch-metadata-of-a-user)
        endpoint.
