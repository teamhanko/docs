...
1. If you do not already have an Auth0 account, [sign up](https://auth0.com/signup). If you do have an account,
[sign in](https://manage.auth0.com/) to access your dashboard.
...
This name is the default name for the `emailaddress` attribute returned by Auth0, so no further configuration should
be required.
